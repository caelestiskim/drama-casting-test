...
export const characters: Character[] = [
  ...
  },
  {
    ...
    allowedFaceTypes: ["INTELLECTUAL_SERIOUS"],
    vector: { power: 14, elegance: 32, intellect: 34, warmth: 10, mystery: 10 },
    genres: ["사극", "판타지", "드라마"],
    roleType: "주인공",
    genderTone: "male",
  ...
  // ───────────────────────────────────────────────
  {
    ...
    vector: { power: 5, elegance: 15, intellect: 8, warmth: 58, mystery: 14 },
    genres: ["로맨스", "드라마"],
    roleType: "주인공",
    genderTone: "neutral",
  ...
  },
  {
    ...
    allowedFaceTypes: ["WARM_FRIENDLY", "SOFT_YOUTH"],
    vector: { power: 8, elegance: 8, intellect: 12, warmth: 62, mystery: 10 },
    genres: ["청춘", "드라마", "로맨스"],
    roleType: "조력자",
    genderTone: "neutral",
  ...
  },
  {
    ...
    name: "청춘 성장형 주인공",
    title: "가볍게 시작해서 갈수록 깊어지는 인물",
    shortDescription: "밝은 외면 뒤에 진지한 서사를 품고 성장하는 청춘 드라마의 주인공",
    allowedFaceTypes: ["SOFT_YOUTH", "WARM_FRIENDLY"],
    vector: { power: 5, elegance: 10, intellect: 18, warmth: 45, mystery: 22 },
    genres: ["청춘", "드라마", "미스터리"],
    roleType: "주인공",
    genderTone: "neutral",
    shareCopy: "내 메인 캐릭터는 청춘 성장형 주인공. 가볍게 시작해서 갈수록 무게가 생기는 쪽.",
  },
  {
    id: "band-leader",
    name: "청춘물 밴드부 선배",
    ...
    vector: { power: 20, elegance: 10, intellect: 8, warmth: 35, mystery: 27 },
    genres: ["청춘", "로맨스", "드라마"],
    roleType: "주인공",
    genderTone: "neutral",
  ...
  },
  {
    ...
    allowedFaceTypes: ["WARM_FRIENDLY", "SOFT_YOUTH"],
    vector: { power: 4, elegance: 34, intellect: 10, warmth: 42, mystery: 10 },
    genres: ["로맨스", "드라마", "청춘"],
    roleType: "주인공",
    genderTone: "neutral",
